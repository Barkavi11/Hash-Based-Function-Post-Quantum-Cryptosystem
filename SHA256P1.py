# -*- coding: utf-8 -*-
"""
Created on Sun Jan 15 21:35:52 2023
...
print("The message in binary form is",(translate(message)))

def b2Tob16(value):
  #takes list of 32 bits
  #convert to string
  value = ''.join([str(x) for x in value])
  #create 4 bit chunks, and add bin-indicator
  binaries = []
...
#Initial Hash Values and Roud Constants
...
print("The output of the pre-process message is",(m))
...
# rotate right
def rotr(x, n): return x[-n:] + x[:-n] # we have a dataset or array, so we get to present all the rows at index 1
# shift right
...
#defining the constants in a simple way
k = initializer(k)
...
h_hex6 = b2Tob16(h6)
h_hex7 = b2Tob16(h7)
h_hex = h_hex1, h_hex1, h_hex2, h_hex3, h_hex4, h_hex5, h_hex6, h_hex7 
#To create the message schedule
#initialize values and constants
k = initializer(k)
h0, h1, h2, h3, h4, h5, h6, h7 = initializer(h_hex, 'tuple')
...
#print("The message schedule is",(w[i]))     
...
#The whole SHA-256(message) function
...
hash = sha256('Hellow')
print("The message digest is",(hash))